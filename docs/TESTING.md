...
**Complexity guards — a third axis (`tests/complexity.rs`).** The file's model above has two dimensions (field *size*, entity *count*). M10 added two more, each found only after a guard had already reported green.
